...
$allowed_pages = ['reservasi','ruangan' , 'peminjaman', 'user', 'utama'];
$page = isset($_GET['page']) && in_array($_GET['page'], $allowed_pages) ? $_GET['page'] : 'utama';
    ...
    <body class="sb-nav-fixed">
        ...
        <div id="layoutSidenav">
            ...
            <div id="layoutSidenav_content">
                <main>
                    <?php
                    // Include halaman sesuai dengan parameter 'page'
                    include $page . '.php';
                    ?>
                </main>
            </div>
